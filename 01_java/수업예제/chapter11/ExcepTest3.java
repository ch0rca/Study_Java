...
public class ExcepTest3 {
	public static void main(String[] args) {
		//mod함수는 CheckedException인 Exception을 throws했기 때문에 반드시 예외 처리해야 한다. 
		try {
		...
		//div함수는 UncheckedException인 ArithmeticException을 throws했기 때문에 필요할 때만 예외 처리한다. 
		System.out.println(MyUtil.div(256, 4));
		try {
			System.out.println(MyUtil.div(256, 0));
		}catch(Exception e) {
			System.out.println(e.getMessage());
		}
//		
